          ...
          <div className='d-block d-md-flex'>
                ...
                <div>
                  <div>
                    <img
                      ...
                      alt='profile'
                      className='card bg-transparent col-4 col-md-10 mx-auto'
                    />
                  </div>
                  <div className='mt-3'>
                    <button
                    ...
                    <div className='text-white d-flex gap-3 mt-2 mt-md-4 align-items-center justify-content-center'>
                      <i
                        className='bi bi-pencil fw-bold fs-4'
                        style={{ color: '#015FC7' }}
                      ></i>{' '}
                      Edit Profile
                    </div>
            ...
            <div className='card bg-transparent col-12 col-md-6 mt-4 mt-md-0 border-0 d-flex d-lg-block justify-content-center mx-auto'>
              <div className='d-flex'>
                ...
                >
                  <div>
                    <p style={{ color: '#015FC7' }}>
                      Name: <br /> <span className='text-white'>Malakel</span>
                    </p>
                  </div>
                  <div>
                    <p style={{ color: '#015FC7' }}>
                      father's/Mother's Name: <br />{' '}
                      <span className='text-white'>Enyi</span>
                    </p>
                  </div>
                  <div>
                    <p style={{ color: '#015FC7' }}>
                      Age: <br /> <span className='text-white'>19</span>
                    </p>
                  </div>
                  <div>
                    <p style={{ color: '#015FC7' }}>
                      Email: <br />{' '}
                      <span className='text-white'>john.doe@gmail.com</span>
                    </p>
                  </div>
                  <div>
                    <p style={{ color: '#015FC7' }}>
                  ...
                  <div>
                    <p style={{ color: '#015FC7' }}>
                      Eligible <br /> <span className='text-white'>True</span>
                    </p>
                  </div>
                </div>
                <div
                  className='additional-Info pt-3 pt-md-0 p-3 w-100 '
                  style={{ backgroundColor: '#001124' }}
                >
                  <div>
                    <p style={{ color: '#015FC7' }}>
                      Phone Number <br />{' '}
                      <span className='text-white'>+234 20193909</span>
                    </p>
                  </div>
                  <div className='mt-5'>
                    <p style={{ color: '#015FC7' }}>
                      Verified <br /> <span className='text-white'>True</span>
                    </p>
                  </div>
                </div>
              </div>
